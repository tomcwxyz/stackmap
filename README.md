...
[![Tests](https://img.shields.io/badge/tests-1133%20passing-brightgreen.svg)]()
...
Stackmap follows a strict TDD workflow (red, green, refactor). The test suite currently includes **1133 tests across 83 test files**.
