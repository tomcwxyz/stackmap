...
│   ├── views/              # Systems table, diagram, board report, ROPA
...
Stackmap follows a strict TDD workflow (red, green, refactor). The test suite currently includes **1004 tests across 80 test files**.
